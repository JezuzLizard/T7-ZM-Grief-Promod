...
{
	logline1 = "_globallogic_spawn.gsc spawnPlayer() is called" + "\n";
	logprint( logline1 );
	...
	logline1 = "_globallogic_spawn.gsc spawnPlayer() sets sessionstate to playing for " + self.name + "\n";
	logprint( logline1 );
...
{
	logline1 = "_globallogic_spawn.gsc spawnClient() is called" + "\n";
	logprint( logline1 );
...
{
	logline1 = "_globallogic_spawn.gsc waitAndSpawnClient() is called" + "\n";
	logprint( logline1 );
	self endon ( "disconnect" );
	self endon ( "end_respawn" );
	level endon ( "game_ended" );
