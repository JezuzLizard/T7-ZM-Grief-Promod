...
{
	logline1 = "_globallogic_player.gsc Callback_onPlayerConnect() is called " + "\n";
	logprint( logline1 );
	...
	if( !level.splitscreen && !isdefined( self.pers["score"] ) )
	{
		...
		logline1 = "_globallogic_player.gsc Callback_onPlayerConnect() player: " + self.name + " connected " + "\n";
		logprint( logline1 );
	}
	...
	if( GameModeIsMode( GAMEMODE_PUBLIC_MATCH ) && !isdefined( self.pers["matchesPlayedStatsTracked"] ) )
	{
...
function notifyConnecting()
{
	...
	if( isdefined( self ) )
	{
		logline1 = "_globallogic_player.gsc notifyConnecting() player " + self.name + " is connecting " + "\n";
		logprint( logline1 );
