...
#precache( "string", "ZOMBIE_PLAYER_IS_REVIVING_YOU", "ZOMBIE_PLAYER_NAME_8" );
#precache( "string", "ZOMBIE_PLAYER_IS_REVIVING_YOU", "ZOMBIE_PLAYER_NAME_9" );
#precache( "string", "ZOMBIE_PLAYER_IS_REVIVING_YOU", "ZOMBIE_PLAYER_NAME_10" );
#precache( "string", "ZOMBIE_PLAYER_IS_REVIVING_YOU", "ZOMBIE_PLAYER_NAME_11" );
#precache( "string", "ZOMBIE_PLAYER_IS_REVIVING_YOU", "ZOMBIE_PLAYER_NAME_12" );
#precache( "string", "ZOMBIE_PLAYER_IS_REVIVING_YOU", "ZOMBIE_PLAYER_NAME_13" );
#precache( "string", "ZOMBIE_PLAYER_IS_REVIVING_YOU", "ZOMBIE_PLAYER_NAME_14" );
#precache( "string", "ZOMBIE_PLAYER_IS_REVIVING_YOU", "ZOMBIE_PLAYER_NAME_15" );
#precache( "string", "ZOMBIE_PLAYER_IS_REVIVING_YOU", "ZOMBIE_PLAYER_NAME_16" );
#precache( "string", "ZOMBIE_PLAYER_IS_REVIVING_YOU", "ZOMBIE_PLAYER_NAME_17" );
...
function laststand_global_init()
{
	...
	level.player_name_directive[8] = &"ZOMBIE_PLAYER_NAME_8";
	level.player_name_directive[9] = &"ZOMBIE_PLAYER_NAME_9";
	level.player_name_directive[10] = &"ZOMBIE_PLAYER_NAME_10";
	level.player_name_directive[11] = &"ZOMBIE_PLAYER_NAME_11";
	level.player_name_directive[12] = &"ZOMBIE_PLAYER_NAME_12";
	level.player_name_directive[13] = &"ZOMBIE_PLAYER_NAME_13";
	level.player_name_directive[14] = &"ZOMBIE_PLAYER_NAME_14";
	level.player_name_directive[15] = &"ZOMBIE_PLAYER_NAME_15";
	level.player_name_directive[16] = &"ZOMBIE_PLAYER_NAME_16";
	level.player_name_directive[17] = &"ZOMBIE_PLAYER_NAME_17";
}
