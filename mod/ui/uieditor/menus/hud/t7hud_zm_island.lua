...
function LUI.createMenu.T7Hud_zm_island(InstanceRef)
    local HudRef = CoD.Menu.NewForUIEditor("T7Hud_zm_island")
    ...
    HudRef.buttonModel = Engine.CreateModel(Engine.GetModelForController(InstanceRef), "T7Hud_zm_island.buttonPrompts")
    ...
    local function HudCloseCallback(SenderObj)
        ...
        Engine.GetModel(Engine.GetModelForController(InstanceRef), "T7Hud_zm_island.buttonPrompts")
