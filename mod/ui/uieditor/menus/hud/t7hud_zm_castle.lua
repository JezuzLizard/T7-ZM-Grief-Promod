...
function LUI.createMenu.T7Hud_zm_castle(InstanceRef)
    local HudRef = CoD.Menu.NewForUIEditor("T7Hud_zm_castle")
    ...
    HudRef.buttonModel = Engine.CreateModel(Engine.GetModelForController(InstanceRef), "T7Hud_zm_castle.buttonPrompts")
    ...
    local function HudCloseCallback(SenderObj)
        ...
        Engine.GetModel(Engine.GetModelForController(InstanceRef), "T7Hud_zm_castle.buttonPrompts")
