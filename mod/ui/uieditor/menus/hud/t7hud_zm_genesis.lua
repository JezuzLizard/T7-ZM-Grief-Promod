...
function LUI.createMenu.T7Hud_zm_genesis(InstanceRef)
    local HudRef = CoD.Menu.NewForUIEditor("T7Hud_zm_genesis")
    ...
    HudRef.buttonModel = Engine.CreateModel(Engine.GetModelForController(InstanceRef), "T7Hud_zm_genesis.buttonPrompts")
    ...
    local function HudCloseCallback(SenderObj)
        ...
        Engine.GetModel(Engine.GetModelForController(InstanceRef), "T7Hud_zm_genesis.buttonPrompts")
