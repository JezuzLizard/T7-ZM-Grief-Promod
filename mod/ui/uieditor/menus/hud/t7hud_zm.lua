...
function LUI.createMenu.T7Hud_zm(InstanceRef)
    local HudRef = CoD.Menu.NewForUIEditor("T7Hud_zm")
    ...
    HudRef.buttonModel = Engine.CreateModel(Engine.GetModelForController(InstanceRef), "T7Hud_zm.buttonPrompts")
    ...
    local function HudCloseCallback(SenderObj)
        ...
        Engine.GetModel(Engine.GetModelForController(InstanceRef), "T7Hud_zm.buttonPrompts")
