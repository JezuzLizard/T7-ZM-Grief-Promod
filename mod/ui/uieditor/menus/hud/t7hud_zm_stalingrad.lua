...
function LUI.createMenu.T7Hud_zm_stalingrad(InstanceRef)
    local HudRef = CoD.Menu.NewForUIEditor("T7Hud_zm_stalingrad")
    ...
    HudRef.buttonModel = Engine.CreateModel(Engine.GetModelForController(InstanceRef), "T7Hud_zm_stalingrad.buttonPrompts")
    ...
    local function HudCloseCallback(SenderObj)
        ...
        Engine.GetModel(Engine.GetModelForController(InstanceRef), "T7Hud_zm_stalingrad.buttonPrompts")
